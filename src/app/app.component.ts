...
export class MyApp {
            ...
            setTimeout(() => {
              switch(this.network.type) {
                case 'wifi':
                  ...
                  break;
                case 'ethernet':
                  console.log('We got an ethernet connection, woohoo!');
                  this.toastCntrl.create({
                ...
                default:
                  ...
                  console.log('Connection restored, woohoo!');
              }
            }, 3000);
          });
    });
  ...
  openReserve() {
    let modal = this.modalCntrl.create(ReservationPage);
    modal.present();
  }

  openLogin() {
    let modal = this.modalCntrl.create(LoginPage);
    modal.present();
  }
}
